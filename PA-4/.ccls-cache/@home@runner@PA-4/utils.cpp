...
void Instruction::setCommand(string cmd) { this->command = cmd; }

void Instruction::setValue(int val) { this->value = val; }

void Instruction::setValueStr(string val) { this->value_str = val; }

string Instruction::getCommand() { return this->command; }

int Instruction::getValue() { return this->value; }

string Instruction::getValueStr() { return this->value_str; }

/* Member functions for InstructionSequence class */
InstructionSequence::InstructionSequence() { this->instructions = NULL; }
...
int InstructionSequence::getLength() { return this->length; }
...
void InstructionSequence::printInstructions() {
    ...
    for (int i = 0; i < this->length; i++) {
        ...
        cout << "  value str : " << this->instructions[i].getValueStr().length()
             << endl;
    }
}
